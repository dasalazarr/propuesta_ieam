        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-1 lg:col-start-3 lg:col-span-2">
            ...
            <div className="flex space-x-4 mb-6">
              <a href="https://x.com/ieamigratorio" target="_blank" rel="noopener noreferrer" className="bg-[#1e4976] p-2 rounded-full hover:bg-[#006994] transition-colors group">
              ...
              <a href="https://www.linkedin.com/company/ieamigratorio" target="_blank" rel="noopener noreferrer" className="bg-[#1e4976] p-2 rounded-full hover:bg-[#006994] transition-colors group">
                <svg viewBox="0 0 24 24" aria-hidden="true" className="w-5 h-5 fill-current text-white group-hover:text-white">
                  <path d="M4.98 3.5c0 1.381-1.11 2.5-2.48 2.5s-2.48-1.119-2.48-2.5c0-1.38 1.11-2.5 2.48-2.5s2.48 1.12 2.48 2.5zm.02 4.5h-5v16h5v-16zm7.982 0h-4.968v16h4.969v-8.399c0-4.67 6.029-5.052 6.029 0v8.399h4.988v-10.131c0-7.88-8.922-7.593-11.018-3.714v-2.155z" />
                </svg>
              </a>
              <a href="https://www.instagram.com/ieamigratorio/" target="_blank" rel="noopener noreferrer" className="bg-[#1e4976] p-2 rounded-full hover:bg-[#006994] transition-colors group">
                <svg viewBox="0 0 24 24" aria-hidden="true" className="w-5 h-5 fill-current text-white group-hover:text-white">
